# Eval run 20260907-112810

| model | kind | n | exact | phonetic | mean WER | mean lev |
|---|---|--:|--:|--:|--:|--:|
| bedrock-haiku | name | 15 | 33% | 60% | 0.622 | 0.200 |
| bedrock-haiku | email | 10 | 30% | 30% | 0.700 | 0.092 |
| gemini-flash | name | 15 | 40% | 60% | 0.467 | 0.160 |
...
| e08 | `deshawn.j@gmail.com` | "DESH at WN.J@gmail.com." | `desh@wn.j@gmail.com` | `deshatwn.j@gmail.com` |
...
| n05 | `Nguyen Thi Hoa` | "Nguyenihoa. The family name is Nguyen, N G U Y E N." | `Nguyenihoa Nguyen` | `Nguyen Ihoa` |
...
- `bedrock-haiku` n05 — expected `Nguyen Thi Hoa`, got `Nguyenihoa Nguyen`
